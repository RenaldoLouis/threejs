...
Files: chair.gltf [1.97MB] > E:\Temp\chair-transformed.glb [278.67KB] (86%)
...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        geometry={nodes.Object_2.geometry} material={materials['default']}
        position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}
      />
    </group>
  )
}
